...
interface InternalPlanItem extends PlanItem {
  id: string; // Internal UUID for UI mapping
}
...
export default function CreatePlanPage() {
  ...
  // Helper to get effective unit price for display
  ...
  const handleSave = async () => {
    ...
    if (items.some(i => !i.serviceId)) {
      toast({ title: "Servicios incompletos", description: "Asegúrate de haber seleccionado un servicio en todas las líneas.", variant: "destructive" });
      return;
    }
            ...
            <CardContent className="pt-4 space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input 
                    id="planName" 
                    placeholder="Ej: Suite Redes Sociales Full" 
                    value={planName}
             ...
             <CardContent className="pt-6">
                <div className="flex items-center justify-between gap-4">
                   <div className="flex items-center gap-4">
                      ...
                      <div>
                         <p className="text-[10px] font-bold uppercase tracking-tighter text-primary/70">Total Estimado del Plan</p>
                         <p className="text-4xl font-black tracking-tight text-primary">{formatCurrency(subtotal)}</p>
                      </div>
                   </div>
